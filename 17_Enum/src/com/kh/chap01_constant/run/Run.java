...
public class Run {	// constant : 상수
	public static void main(String[] args) {
		/*
		 * 상수
		 * 	- 값을 변하지 않는 변수
		 * 	- 저장하고 있는 값에 대해서 가동성과 전달려긍 높이기 위해 사용
