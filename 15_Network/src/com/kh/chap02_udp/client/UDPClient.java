...
public class UDPClient {
	public static void main(String[] args) {
		...
		try {
			...
			// 랜덤 포트번호사용
			DatagramSocket socket = new DatagramSocket();	//(포트번호) 넣지않으면 랜던으로 사용
			...
			String receiveData = new String(sendPacket.getData(),0,sendPacket.getLength());	//범위 : 0 ~ sendPacket.getLength()
