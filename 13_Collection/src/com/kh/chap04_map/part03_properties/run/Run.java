...
public class Run {
	public static void main(String[] args) {
		...
		// map계열을 상속 받았기 때문에 put메서드가 존재한다.
//		prop.put("다이제", new Snack("초코맛",1500));	//이렇게 쓰지는 않음..
		...
		try {
			...
			// 4. stroeToXML(OutputStream os, String Comments)
...
//			prop2.load(new FileInputStream("test.properties"));
			...
			// 6. loadFromXML(InputStream if) : xml을 읽는데 사용하는 메서드.
