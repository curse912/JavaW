...
public class B_Logical {
	...
	public void method4() {
		...
		int num1 = 10;
		// ++ => num1이 가진 값을 1 증가 시키는 단항 연산자
		// and연산자의 경우 A && B의 조건중 A의 값이 false인 경우
		// 뒤 쪽 조건들은 "무조건" false이기 때문에 "뒤쪽 조건식"은 실행되지도 않는다.
		boolean result1 = ( num1 < 5 ) && ( num1++ > 0 ) ; //후위 증감연산자
		
		System.out.println("rusult1 : "+result1);	//false
		System.out.println("num1 : "+num1);	//10
		//앞의 조건이 true이면 뒤에도 true, 앞 조건이 false면 뒤에도 false
		
		int num2 = 10;
		// or연산자는 A||B중 A가 참일경우 뒤쪽 조건식은 검사하지 않고 참을 반환.
		boolean result2 = num2 < 20 || ++num2 > 0; //전위 증감연산자
		// result2 ==> true,
		// num2 => 10
