...
//		ec.insert(new Tablet("애플","아이패드",5000000));
//		
//		System.out.println(ec.selctDestktop());
...
//		System.out.println(ec.selectTablet());
		...
		ec.insert(new Tablet("애플","아이패드",5000000),2);
		 ...
		 * 2. 메소드의 매개변수, 반환형에 다형성이 적용되면 작성해야할 메서드 갯구사 확 줄어든다.
		 * 
		 * */
	}
