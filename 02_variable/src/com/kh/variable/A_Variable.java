...
public class A_Variable {
	...
	public void printVariable() {//run파일에서 선언해줘야함.
		...
		//변수선언
		int pay = 8500; //= 대입연산자(오른쪽을 왼쪽으로 대입)
		int time = 6;
		int day = 5;
	...
	public void declareVariable() {//run파일에서 선언해줘야함.
		/*
		 * 변수의 선언
		 * [표현법]
		 * 자료형 변수명 ;
		 ...
		 * 	  ex) String userName => 이어쓰기당한 뒷단어의 첫글자를 대문자표현
		 * 
		 * 주의점
		...
		double dNum;	//8byte 소수점 15자리까지 표현 ==>실수 대표 자료형
		
		//3. 문자형
		char ch;	//2byte only+
		
		//4. 문자열(참조자료형) => 기본자료형에 포함되지않는다.
		String str;
	...
	public void initVariable() {//run파일에서 선언해줘야함.
		//변수에 값을 대입 == 초기화
		boolean isTrue = false; //초기화 완료
		byte bNum = 1;
		
		int longInteger = 999_999_999;	//가독성을 위한 '_'기호
	}
	
	public void constant() {//run파일에서 선언해줘야함.
		//constant 상수라는 뜻(변경 불가능)
		final int age = 20;
		
		//age = 21; 오류가 뜬다
		
		//상수값을 저장하는 변수는 무조건 '대문자'를 활용한다.
		final int AGE = 21;	//대문자끼리 이어줄때는 '_'사용	
