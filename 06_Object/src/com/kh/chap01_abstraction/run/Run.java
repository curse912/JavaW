...
public class Run {
	...
	public static void main(String[] args) {
		 ...
		 * 
		 *	2. 객체 : 클라스를 통해 메모리(Heap)에 저장공간이 할당된 데이터.{클라스 : 설계도}
		 * 
		 ...
		 * 
		 *	5. 추상화 & 캡슐화 과정이 필요
		 *	  - 내가 구현하고자하는 프로그램의 목적에 맞는 ㅐㄱㄱ체를 선정 후,
		...
		// 1. 학생객체
		//	홍길동 학생 객체 만들기
		Student hong = new Student();	//import 생성
		hong.name = "홍길동";//hong개체 내부(.)의 name 속성값 홍길동
		hong.age = 20;
		hong.height = 180.5;
