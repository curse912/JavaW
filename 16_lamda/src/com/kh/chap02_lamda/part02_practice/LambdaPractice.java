...
public class LambdaPractice {
	public static void main(String[] args) {
		...
		// 3. 매개변수의 () 생략가능. 단, 매개변수가 딱 "1"개 있을 경우
		LambdaTest2 lambda3 = str -> {
			System.out.println(str);
		};
		
		// 4. 중괄호 생략가능. 단, 실행할 코드가 한문장인 경우	(+return 생략가능)
		LambdaTest1 lambda4 = (x,y)-> x+y;	//return도 함께 생랼해줘야함.
		...
		//		x -> { System.out.prinln(x); return x; };
		...
		//		(str1,str2) -> { String result =  (str1.concat(str2)); return result; });
