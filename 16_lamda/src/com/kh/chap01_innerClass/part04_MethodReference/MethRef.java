...
public class MethRef {
	/*
	 * 람다식 매서드 참조(Method Reference)
	 * 	- 기존 람다식 구문 중 이미 존재하는 매서드와 코드가 일치하는 경우, 이미 존재하는 매서드를
	 *    참조하는 방식으로 코드를 더욱 간결하게 바꿀 수 있다.
	 * 	  EX) (String str) -> {return str.length();};
	 * 		   String :: length;
	 * 	- 람다식을 토해 구현한 기능이 이미 정의되어있는 다른 메소드의 기능을 그대로 사용하는 경우, 
	...
	public static void main(String[] args) {
		...
		// 1. static 메서드 참조
		Function<String, Integer> parser;	//STring을 Integer로 바꿈!
